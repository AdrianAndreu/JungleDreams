...
public class CrearHabitacion {
	...
	private JButton botonInsertarHabitacion;
	...
	public void initialize() {
		...
		botonInsertarHabitacion = new JButton("Insertar");
		botonInsertarHabitacion.setFont(new Font("Tahoma", Font.BOLD, 14));
		botonInsertarHabitacion.setActionCommand("crearUsuarioVerdadero");
		botonInsertarHabitacion.setBounds(65, 196, 114, 37);
		panel.add(botonInsertarHabitacion);
		...
		botonInsertarHabitacion.setActionCommand("crearHabitacionVerdadero");
		botonCancelarHabitacion.setActionCommand("crearHabitacionCancelado");
		botonInsertarHabitacion.addActionListener(habitacionesController);
	...
	public JButton getBotonInsertarHabitacion() {
		return botonInsertarHabitacion;
	}

	public void setBotonInsertarHabitacion(JButton botonInsertarHabitacion) {
		this.botonInsertarHabitacion = botonInsertarHabitacion;
	}
